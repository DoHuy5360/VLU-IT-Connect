...
import BaseHeader from "@/layouts/partials/one-ui/Header.vue";
import BaseSidebar from "@/layouts/partials/one-ui/Sidebar.vue";
import BaseSideOverlay from "@/layouts/partials/one-ui/SideOverlay.vue";
import BaseFooter from "@/layouts/partials/one-ui/Footer.vue";
