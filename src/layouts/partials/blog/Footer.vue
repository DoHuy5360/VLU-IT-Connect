<template>
    <div class="bg-secondary text-white">
        <div class="container p-4">
            ...
            <div>
                <span style="font-weight: 500; text-decoration: underline">Cơ sở chính:</span>
                <span style="font-weight: lighter"
                    > Phòng B.01, Tòa nhà A, 69/68 Đặng Thùy Trâm, P.13,
                    Q.Bình Thạnh, Tp.HCM</span
                >
            </div>
            <div>
                <span style="font-weight: 500; text-decoration: underline">Cơ sở 1:</span>
                <span style="font-weight: lighter">
                    Phòng 4.11, 45 Nguyễn Khắc nhu, P.Cô Giang, Q.1,
                    Tp.HCM
                </span>
            </div>
            <div>
                <span style="font-weight: 500; text-decoration: underline">Cơ sở 2:</span>
                <span style="font-weight: lighter">
                    Phòng C.02, 233A Phan Văn Trị, P.11, Q.Bình Thạnh,
                    Tp.HCM
                </span>
            </div>
            ...
            <div class="d-flex justify-content-between mt-5">
                <div>2024 © P.CNTT</div>
                <div class="d-flex gap-3" style="font-weight: 100;">
