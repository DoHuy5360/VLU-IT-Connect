    ...
    <div class="container py-3">
        <div class="row gx-3 gy-2 align-items-stretch">
            ...
            <div class="col-lg-6 h-120 d-flex flex-column" v-if="featuredArticle">
                <!-- ✅ Thêm h-100 và d-flex -->
                <div class="rounded p-4 bg-white border shadow-sm flex-grow-1">
                    <!-- ✅ Thêm flex-grow-1 -->
...
export default {
    ...
    async created() {
        try {
            ...
            posts = posts.filter((post) => post.published === true).sort((a, b) => new Date(b.publishedAt) - new Date(a.publishedAt));
