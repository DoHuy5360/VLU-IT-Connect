  ...
  <tr>
    ...
    <td class="text-left">
      <div
        ...
        class="d-flex"
        style="cursor: pointer; width: fit-content; user-select: none"
      >
        <span
          v-if="hasChildren"
          class="btn btn-sm btn-link p-0 me-2"
          :style="{ marginLeft: `${20 * category.nestDepth}px` }"
        >
          <i
    ...
    <td class="">
      <div class="d-flex gap-2 justify-content-center">
        <button
          ...
          @click="$router.push(`/administrator/category/edit/${category.code}`)"
        >
